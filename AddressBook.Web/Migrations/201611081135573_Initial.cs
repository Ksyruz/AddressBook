                ...
                c => new
                    {
                        ...
                        Surname = c.String(maxLength: 16, unicode: false),
                        Forename = c.String(maxLength: 16, unicode: false),
                        PhoneIntlDialCode = c.Int(nullable: false),
                        PhoneNumber = c.String(maxLength: 16, unicode: false),
                        EmailAddress = c.String(maxLength: 64),
                        TwitterId = c.String(maxLength: 32, unicode: false),
